...
- List of authors: [AUTHORS.md](https://DFT2kp_effective_kp_models/blob/main/AUTHORS.md)
- References to cite if we use our code: [CITING.md](https://DFT2kp_effective_kp_models/blob/main/CITING.md)
- Quick install intructions and compatibility requirements: [INSTALL.md](https://DFT2kp_effective_kp_models/blob/main/INSTALL.md)
